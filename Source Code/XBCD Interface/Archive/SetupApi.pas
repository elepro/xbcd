...
function CM_Get_Device_Interface_ListA(InterfaceClassGuid: PGUID; pDeviceID: PCHAR; Buffer: PCHAR; BufferLen: ULONG; ulFlags: ULONG): DWORD; stdcall;
{$EXTERNALSYM CM_Get_Device_Interface_ListA}
...
function CM_Get_Device_Interface_ListA; external CfgMgrDll name 'CM_Get_Device_Interface_ListA';
